...
- ###  [Exploratory Data Analysis and Visualization for TikTok Content Insights](https://github.com/IoannisChalk/Portfolio/tree/main/Data%20Analysis%20and%20Machine%20Learning/Exploratory_Data_Analysis_TikTok_Content)
...
- ### "Semantic Image Segmentation with U-Net for Autonomous Driving"
  Designed and implemented a U-Net model for pixel-wise classification, enabling precise segmentation on the CARLA self-driving car dataset. Utilized sparse categorical crossentropy and advanced upsampling techniques for accurate object detection in complex scenes.
...
- ### "Neural Machine Translation with Attention Mechanisms"
  Developed a sequence-to-sequence model with attention to translate human-readable dates into machine-readable formats. Implemented an advanced attention mechanism to improve alignment and accuracy in sequence modeling tasks.
...
- ### [Sentiment Analysis of Movie Reviews Using Natural Language Processing (NLP)](https://github.com/IoannisChalk/Portfolio/tree/main/NLP%20and%20LLMs/Movie%20Reviews%20Sentiment%20Analysis)
  Developed a comprehensive sentiment analysis pipeline to classify movie reviews as positive or negative using Natural Language Processing (NLP) techniques. Implemented two distinct approaches: a machine learning model leveraging TF-IDF vectorization and Linear Support Vector Classification (SVC), and a lexicon-based method using the VADER Sentiment Analyzer. Conducted data preprocessing, including cleaning missing values, tokenization, and removing irrelevant data points. Evaluated model performance using metrics such as accuracy, precision, recall, and F1-score, demonstrating strong analytical and problem-solving skills in sentiment classification and model evaluation
